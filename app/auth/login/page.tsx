  ...
  return (
    <div className="min-h-screen bg-background transition-colors duration-300 flex">
      ...
      <div className="hidden lg:flex lg:w-[52%] relative overflow-hidden flex-col">
        ...
        {/* Red accent glow */}
        <div className="absolute top-[-10%] left-[-10%] w-[60%] h-[60%] rounded-full bg-orange-500/10 blur-[120px] pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col justify-between h-full p-12">
          ...
          >
            ...
            <span className="text-xl font-bold text-white tracking-tight">
              Hoop<span className="text-orange-500">OS</span>
            </span>
          </motion.div>
          ...
          >
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-400 text-xs font-medium">
                ...
                Canadian Basketball&apos;s #1 Platform
              </div>
              <h1 className="text-4xl font-bold text-white leading-tight">
                Welcome Back to
                <span className="block text-transparent bg-clip-text bg-linear-to-r from-orange-400 to-amber-400">
                  CricOS
                </span>
              </h1>
              <p className="text-slate-400 text-base leading-relaxed max-w-sm">
                Manage your club, track performance, and connect with the cricket community worldwide.
              </p>
            </div>
            ...
            <div className="bg-[#161B27]/80 border border-[#1E2A3A] rounded-2xl p-5 backdrop-blur-sm space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white font-semibold text-sm">Mumbai Lions CC</p>
                    <p className="text-slate-500 text-xs">MCA Premier Division</p>
                  </div>
                </div>
          ...
          >
            <p className="text-slate-500 text-sm italic">
              &ldquo;The only platform built specifically for cricket clubs worldwide.&rdquo;
            </p>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-8 lg:p-12 relative">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[min(600px,_100vw)] h-[min(600px,_100vw)] rounded-full bg-orange-500/5 blur-[100px] pointer-events-none" />
