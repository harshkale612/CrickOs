  ...
  return (
    <div className="min-h-screen bg-background transition-colors duration-300 flex">
      ...
      <div className="hidden lg:flex lg:w-[420px] xl:w-[480px] flex-col relative overflow-hidden shrink-0">
        ...
        />
        <div className="absolute top-0 right-0 w-[300px] h-[300px] rounded-full bg-orange-500/8 blur-[100px]" />
        ...
        <div className="relative z-10 flex flex-col h-full p-10">
          ...
          <div className="flex items-center gap-3 mb-12">
            ...
            <span className="text-xl font-bold text-white tracking-tight">
              Hoop<span className="text-red-500">OS</span>
            </span>
          </div>
          ...
          <div className="flex-1 flex flex-col justify-center space-y-8">
            ...
            <div className="space-y-3">
              {[
                { n: 1, label: 'Choose your role', sub: 'How do you use CricOS?' },
                  ...
                  >
                    <motion.div variants={itemVariants}>
                      ...
                      <p className="text-muted-foreground text-sm">
                        We&apos;ll personalise your experience based on how you use CricOS.
                      </p>
                    </motion.div>
                        ...
                        <>
                          <FormGroup>
                            ...
                            <Input
                              id="clubName"
                              type="text"
                              placeholder="e.g. Mumbai Lions CC"
                              value={clubName}
