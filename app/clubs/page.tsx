  ...
  return (
    <div className="min-h-screen bg-background transition-colors duration-300 flex flex-col">
      ...
      <section className="pt-24 pb-12 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0 hoop-grid opacity-30 pointer-events-none" />
        <div className="max-w-7xl mx-auto relative">
          <motion.div
            ...
            className="mb-3"
          >
            <Badge variant="red" dot>Basketball Clubs</Badge>
          </motion.div>
          <motion.h1
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Canadian Basketball <span className="gradient-text">Clubs</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Discover Canada&apos;s premier cricket clubs — their history, achievements, players, and
              ...
              >
                <Link href={`/clubs/${club.id}`} className="block group">
                  <Card hover className="overflow-hidden flex flex-col h-full">
                    ...
                    >
                      {/* Grid overlay */}
                      <div className="absolute inset-0 hoop-grid opacity-20" />
                      {/* Initials */}
