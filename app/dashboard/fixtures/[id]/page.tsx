          ...
          {isCompleted && match.stats && (
            <Card>
              ...
              <CardContent className="space-y-5">
                <StatRow
                  label="Run Rate"
                  homeValue={match.stats.run_rate.home}
                  awayValue={match.stats.run_rate.away}
                />
                <StatRow
                  label="Overs"
                  homeValue={match.stats.overs.home}
                  awayValue={match.stats.overs.away}
                />
                <StatRow
                  label="Wickets"
                  homeValue={match.stats.wickets.home}
                  awayValue={match.stats.wickets.away}
                />
                <StatRow
                  label="Boundaries (4s)"
                  homeValue={match.stats.boundaries.home}
                  awayValue={match.stats.boundaries.away}
                />
                <StatRow
                  label="Sixes (6s)"
                  homeValue={match.stats.sixes.home}
                  awayValue={match.stats.sixes.away}
                />
                <StatRow
                  label="Extras"
                  homeValue={match.stats.extras.home}
                  awayValue={match.stats.extras.away}
                />
                <StatRow
                  label="Wides"
                  homeValue={match.stats.wides.home}
                  awayValue={match.stats.wides.away}
                />
                <StatRow
                  label="No Balls"
                  homeValue={match.stats.no_balls.home}
                  awayValue={match.stats.no_balls.away}
                />
              </CardContent>
            </Card>
          )}
