  ...
  return (
    <div className="flex flex-col min-h-full">
      <DashboardHeader
        ...
        subtitle="Season 2024 · MCA Premier Division"
        actions={
      ...
      <main className="flex-1 px-4 py-4 sm:px-6 sm:py-6 space-y-4 sm:space-y-6 max-w-none">
        ...
        {liveMatches.length > 0 && liveMatches.map((lm) => (
          <Link key={lm.id} href={`/dashboard/fixtures/${lm.id}`} className="block mb-2">
            <div className="flex flex-wrap items-center gap-2 sm:gap-4 bg-orange-500/8 border border-orange-500/30 rounded-xl px-4 sm:px-8 py-4 sm:py-5 cursor-pointer hover:bg-orange-500/12 transition-colors">
              <div className="flex items-center gap-2 shrink-0">
