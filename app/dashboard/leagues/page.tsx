          ...
          {sorted.map((row) => (
            <tr
              ...
              className={cn(
                'transition-colors',
                row.isUserTeam
                  ? 'bg-orange-500/6 hover:bg-orange-500/10 border-l-2 border-l-orange-500'
              ...
              <td className="py-3 px-2 text-center">
                <span
                  className={cn(
                    ...
                    row.isUserTeam ? 'text-orange-400' : 'text-foreground',
                  )}
                >
                  {row.points}
                </span>
...
export default function LeaguesPage() {
  ...
  const [selectedLeagueId, setSelectedLeagueId] = useState('oba-premier');
    ...
    <div className="flex flex-col min-h-full">
      ...
      <main className="flex-1 px-4 py-4 sm:px-6 sm:py-6 space-y-4 sm:space-y-6 max-w-none">
                  ...
                  <div className="flex items-start gap-3 pr-8">
                    ...
                    >
                      <Trophy
                        className={cn(
                          'h-4 w-4',
                          selectedLeagueId === league.id ? 'text-orange-400' : 'text-muted-foreground',
                        )}
                      />
                    </div>
        ...
        <div className="flex items-center gap-6 text-[11px] text-muted-foreground">
          ...
          <span className="flex items-center gap-1.5">
            <span className="h-3 w-3 rounded-full bg-orange-500/60 inline-block" />
            Your team
          </span>
