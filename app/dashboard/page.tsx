...
export default function DashboardPage() {
  ...
  return (
    <div className="flex flex-col min-h-full">
      <DashboardHeader
        title="Dashboard"
        subtitle="Mumbai Lions CC — MCA Premier Division"
      />
                ...
                <CardHeader className="pb-4">
                  <div className="flex flex-wrap items-start justify-between gap-2">
                    <div>
                      ...
                      <CardDescription className="mt-1">Runs for vs against — last 7 rounds</CardDescription>
                    </div>
                ...
                <CardContent className="pt-1 pb-2">
                  <div className="divide-y divide-border">
                    {upcomingMatches.map((match, idx) => {
                      const isHome = match.homeTeam.id === 'mumbai-lions';
              ...
              <Card>
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="gold" size="sm" dot>MCA Premier</Badge>
                  </div>
                    ...
                    {topStandings.map((team, idx) => (
                      ...
                      >
                        ...
                        <span className={cn(
                          ...
                          {team.teamShortName === 'MUM' ? 'Mumbai Lions' : team.teamName}
                        </span>
