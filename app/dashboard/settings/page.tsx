              ...
              <Card>
                <CardContent className="pt-5">
                  ...
                  <div className="space-y-4">
                    ...
                    <FormGroup>
                      <Label>Email</Label>
                      <Input type="email" defaultValue="b.kelly@torontoarrowsbc.ca" />
                    </FormGroup>
                    <FormGroup>
                      <Label>Phone</Label>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <FormGroup>
                      ...
                      <Input defaultValue="Mumbai Lions CC" />
                    </FormGroup>
                    <div className="grid grid-cols-2 gap-3">
                      <FormGroup>
                        <Label>City</Label>
                      ...
                      <FormGroup>
                        ...
                        <select className="flex h-10 w-full rounded-lg border bg-background px-3 py-2 text-sm text-foreground border-border focus:border-orange-500/60 focus:outline-none" defaultValue="Ontario">
                    ...
                    <FormGroup>
                      ...
                      <Input defaultValue="Mumbai Cricket Association — Premier Division" />
                    </FormGroup>
                    <FormGroup>
