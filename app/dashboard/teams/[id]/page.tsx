...
const upcomingMatches = [
  { id: 1, date: '2024-11-02', opponent: 'Kolkata Royals CC', venue: 'Wankhede Stadium Practice Ground', isHome: true, competition: 'MCA Premier Division' },
  { id: 2, date: '2024-11-09', opponent: 'Pune Warriors CC', venue: 'MCA Cricket Ground, Pune', isHome: false, competition: 'MCA Premier Division' },
  { id: 3, date: '2024-11-23', opponent: 'Hyderabad Hawks CC', venue: 'Wankhede Stadium Practice Ground', isHome: true, competition: 'MCA Premier Division' },
];
...
export default function TeamDetailPage() {
  ...
  const statsGrid = [
    ...
    { label: 'Wickets Taken', value: team.stats.wickets, color: 'text-orange-400' },
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center gap-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-orange-400">{team.coach.role}</p>
              </div>
            </div>
          </div>
        </motion.div>
                                ...
                                <td className="pr-5 pl-2 py-3">
                                  <div className="flex items-center justify-end opacity-0 group-hover/row:opacity-100 transition-opacity gap-1">
                                    ...
                                    <button
                                      ...
                                      className="h-7 w-7 rounded-md flex items-center justify-center text-muted-foreground hover:text-orange-400 hover:bg-orange-500/10 transition-colors"
