        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 mb-12">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-xl">
              Live standings, rankings, and results from cricket competitions.
            </p>
          </motion.div>
        </div>
                  ...
                  <table className="data-table">
                    ...
                    <tbody>
                      {league.standings.slice(0, 6).map((s) => (
                        <tr
                          key={s.teamId}
                          className={cn(s.isUserTeam && 'bg-orange-500/5 border-l-2 border-l-orange-500')}
                        >
                          <td>
                            <span className={cn(
                          ...
                          <td>
                            <div className="flex items-center gap-2">
                              ...
                              <span className={cn('font-medium', s.isUserTeam ? 'text-orange-400' : 'text-foreground')}>
                                {s.teamName}
                              </span>
