...
const leagues: League[] = [
  {
    ...
    season: '2024 Season',
    rows: [
      { position: 1, team: 'Mumbai Lions CC', played: 14, won: 11, drawn: 1, lost: 2, pointsFor: 2614, pointsAgainst: 1987, points: 54, form: ['W', 'W', 'D', 'W', 'W'], isUserTeam: true },
      { position: 2, team: 'Delhi Strikers CC', played: 14, won: 10, drawn: 0, lost: 4, pointsFor: 2487, pointsAgainst: 2110, points: 46, form: ['L', 'W', 'W', 'W', 'W'] },
      { position: 3, team: 'Chennai Kings CC', played: 14, won: 9, drawn: 1, lost: 4, pointsFor: 2361, pointsAgainst: 2224, points: 43, form: ['W', 'L', 'W', 'D', 'W'] },
      { position: 4, team: 'Bangalore Eagles CC', played: 14, won: 8, drawn: 0, lost: 6, pointsFor: 2240, pointsAgainst: 2238, points: 40, form: ['D', 'W', 'W', 'L', 'W'] },
      { position: 5, team: 'Hyderabad Hawks CC', played: 14, won: 7, drawn: 1, lost: 6, pointsFor: 2128, pointsAgainst: 2241, points: 35, form: ['L', 'W', 'L', 'W', 'D'] },
      { position: 6, team: 'Kolkata Royals CC', played: 14, won: 5, drawn: 0, lost: 9, pointsFor: 1895, pointsAgainst: 2278, points: 24, form: ['L', 'L', 'W', 'L', 'W'] },
      { position: 7, team: 'Pune Warriors CC', played: 14, won: 3, drawn: 1, lost: 10, pointsFor: 1768, pointsAgainst: 2402, points: 15, form: ['L', 'D', 'L', 'L', 'L'] },
      { position: 8, team: 'Jaipur Panthers CC', played: 14, won: 2, drawn: 0, lost: 12, pointsFor: 1540, pointsAgainst: 2540, points: 8, form: ['L', 'L', 'L', 'W', 'L'] },
    ],
  },
  {
    name: 'KSCA Premier Division — Bangalore',
    season: '2024 Season',
    rows: [
      { position: 1, team: 'Bangalore Eagles CC', played: 12, won: 10, drawn: 0, lost: 2, pointsFor: 2298, pointsAgainst: 1872, points: 50, form: ['W', 'W', 'W', 'W', 'L'] },
      { position: 2, team: 'Mysore Lions CC', played: 12, won: 9, drawn: 1, lost: 2, pointsFor: 2171, pointsAgainst: 1888, points: 46, form: ['W', 'D', 'W', 'W', 'W'] },
      { position: 3, team: 'Mangalore Titans CC', played: 12, won: 7, drawn: 0, lost: 5, pointsFor: 1924, pointsAgainst: 1915, points: 34, form: ['L', 'W', 'W', 'L', 'W'] },
      { position: 4, team: 'Hubli Hawks CC', played: 12, won: 5, drawn: 2, lost: 5, pointsFor: 1798, pointsAgainst: 1920, points: 28, form: ['D', 'L', 'W', 'W', 'D'] },
      { position: 5, team: 'Bellary Royals CC', played: 12, won: 4, drawn: 0, lost: 8, pointsFor: 1670, pointsAgainst: 2058, points: 20, form: ['L', 'L', 'W', 'L', 'L'] },
      { position: 6, team: 'Bidar Warriors CC', played: 12, won: 1, drawn: 1, lost: 10, pointsFor: 1428, pointsAgainst: 2316, points: 7, form: ['L', 'L', 'D', 'L', 'L'] },
    ],
  },
];
    ...
    >
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden">
              ...
              {league.rows.map((row, i) => (
                <motion.tr
                  ...
                  className={`relative border-b last:border-b-0 transition-colors duration-200 ${
                    row.isUserTeam
                      ? 'border-orange-900/30 bg-orange-500/5 hover:bg-orange-500/10'
        ...
        <div className="px-5 py-3 border-t border-border flex items-center gap-4 flex-wrap">
          ...
          <span className="text-muted-foreground text-xs font-medium ml-4">PF = Runs For · PA = Runs Against</span>
        </div>
      </div>
    </motion.div>
  );
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg max-w-xl">
              Complete league tables, form guides, and points breakdowns for all cricket competitions.
            </p>
          </motion.div>
