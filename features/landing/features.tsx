...
const features: FeatureCard[] = [
  ...
  },
  {
    ...
    description:
      'Deep analytics on team and player performance — from batting averages to bowling economy rates, all visualised beautifully.',
    tags: ['Performance Trends', 'Batting & Bowling Analytics', 'Export Reports'],
  },
  {
    id: 'communications',
    ...
    >
      <Card hover className="h-full group transition-all duration-300">
        <CardContent className="p-6 flex flex-col gap-4 h-full">
          {/* Icon */}
          <div className={`inline-flex w-11 h-11 rounded-xl items-center justify-center shrink-0 ${feature.iconBg} transition-transform duration-300 group-hover:scale-110`}>
            {feature.icon}
          </div>

          {/* Text */}
          <div className="flex flex-col gap-2 flex-1">
            <h3 className="text-base font-bold text-foreground leading-snug group-hover:text-orange-500 transition-colors duration-200">
              {feature.title}
            </h3>
...
export function LandingFeatures() {
  ...
  return (
    <section
      id="features"
      ref={ref}
      className="relative py-12 sm:py-16 xl:py-28 overflow-hidden"
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* ── Section Header ── */}
        <motion.div
          className="text-center mb-8 sm:mb-12 xl:mb-14 max-w-2xl mx-auto"
        ...
        >
          ...
          <p className="mt-4 text-base text-muted-foreground leading-relaxed">
            One platform purpose-built for cricket — no duct tape, no spreadsheets,
            no switching between a dozen tools.
          </p>
        </motion.div>

        {/* ── Feature Grid (2-col desktop, 1-col mobile) ── */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 xl:gap-5 mb-5">
