  ...
  return (
    <motion.tr
      ...
      className={`
        ...
        ${row.isUserTeam
          ? 'border-orange-900/30 bg-orange-600/5 hover:bg-orange-600/10'
        ...
        >
          ...
          <div className="flex items-center justify-between px-5 py-4 border-b border-border">
            <div className="flex items-center gap-2">
              ...
              <span className="text-foreground font-semibold text-sm">Mumbai Cricket Association — Premier Division</span>
            </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-90 sm:min-w-120">
              <thead>
