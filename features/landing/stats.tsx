...
const stats: StatBlock[] = [
  ...
  },
  {
    ...
    suffix: '+',
    prefix: '',
    label: 'Active Clubs Worldwide',
    descriptor: 'Cricket clubs worldwide using CricOS to manage their operations end-to-end.',
  ...
  },
  {
    ...
    descriptor: 'Fixtures recorded with results, standings updates, and live scorecard publishing.',
  ...
  },
  {
    ...
    descriptor: 'Clubs rating CricOS as excellent or outstanding in their post-onboarding survey.',
...
function AnimatedNumber({
  ...
  return (
    <motion.span
      className="gradient-text-gold text-4xl sm:text-5xl xl:text-6xl font-extrabold leading-none tracking-tight"
...
export function LandingStats() {
  ...
  return (
    <section
      ref={ref}
      className="relative py-12 sm:py-16 xl:py-28 border-t border-b border-border overflow-hidden"
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <motion.div
          className="text-center mb-8 sm:mb-12 xl:mb-14"
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-foreground leading-tight">
            Powering Cricket Clubs Worldwide
          </h2>
          <p className="mt-3 text-base text-muted-foreground max-w-xl mx-auto">
            From grassroots clubs to premier associations, CricOS is the platform
            cricket trusts to manage what matters.
          </p>
        </motion.div>
