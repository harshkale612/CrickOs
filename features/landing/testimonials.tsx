...
const testimonials: Testimonial[] = [
  {
    id: 1,
    quote:
      'CricOS has completely transformed how we run Mumbai Lions. Player management, match schedules, and communications all in one place.',
    name: 'Rajesh Kumar',
    role: 'Head Coach',
    club: 'Mumbai Lions CC',
    avatarSeed: 'RajeshKumar',
  },
  {
    id: 2,
    quote:
      "The analytics dashboard gives us batting and bowling insights we've never had before. Our coaches make better decisions every match because of this platform.",
    name: 'Priya Sharma',
    role: 'Assistant Coach (Batting)',
    club: 'Mumbai Lions CC',
    avatarSeed: 'PriyaSharma',
  },
  {
    id: 3,
    quote:
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between">
        <StarRating />
        <div className="w-8 h-8 rounded-full bg-orange-500/15 flex items-center justify-center border border-orange-500/20">
          <Quote className="w-4 h-4 text-orange-500 fill-orange-500/30" />
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Trusted by Cricket Clubs Worldwide
          </h2>
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">
            From coaches to administrators — see what cricket professionals are saying about CricOS.
          </p>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-muted-foreground text-sm">
              <span className="text-foreground font-semibold">200+</span> clubs worldwide
            </span>
          </div>
